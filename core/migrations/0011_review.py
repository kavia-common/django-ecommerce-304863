    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("is_approved", models.BooleanField(default=False, help_text="If false, the review is hidden from public endpoints until moderated.")),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
                    "item",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="reviews", to="core.item"),
                ),
                (
                    "user",
